...
const Typography = (props) => {
  const variants = {
    ...
    h4: 'text-lg font-[canela] uppercase text-primary-200 font-medium tracking-widest',
    h5: 'text-2xl font-[google] uppercase' /**Black title font-size 24px (CART, DASHBAORD, CONTACT US) */,
    h6: 'text-sm font-[google] uppercase text-primary-50 tracking-wide' /**Footer Section Titles */,
